public class HelloWorldExcercises_Completed {
    ...
    String emoji = "\uD83D\uDE00";
        ...
        System.out.println("Hola, ¿Cuanto tiempo?");
        System.out.println("Esta es otra de mis practicas en este lenguaje");
        System.out.println("Me gusta Solo Leveling.....ARISE!!!");
